...
export interface PlannerStore {
  ...
  /** Defer in-memory side effects until the outer transaction commits. A
   * rollback must discard callbacks registered within the rolled-back scope.
   * Outside a transaction, run the callback immediately. */
  ...
  listRecurrenceSeriesByLogicalSeriesId(
