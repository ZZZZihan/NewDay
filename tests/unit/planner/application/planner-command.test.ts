...
import { clearUndoReceipts, undoPlannerCommand } from "@newday/core/application/planner-undo";
...
describe("planner undo", () => {
  ...
  it("undoes recurring deletion including exclusion and focus", async () => {
    ...
    const occurrence = task({
      ...
      logicalSeriesId: originalSeries.logicalSeriesId,
      occurrenceDate: TODAY,
